...
%""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
% PROP覵ITO:
% Funci髇 que calcula la estimaci髇 de la entrop韆 muestral SampEn de una 
% se馻l. 
% FORMA DE USO:
%	[res] = SampEn(X)
%
% ARGUMENTOS...
% ...DE ENTRADA: 
%       .-X ---> se馻l de la que se pretende estimar la SampEn.
% ...DE  SALIDA: 
...
%
% Los par醡etros han sido fijados siguiendo las referencias: Pincus 91,
% Pincus 94, Pincus 01.
% 
% m=2  y r=0.2*SD, siendo SD la desviaci髇 estandar de los datos.
%
%""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
% AUTHORS:
% REBECA GOYA ESTEBAN
...
%
%""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
%%% Modify 2019.10.22 绝对值距离修改为dtw距离
%   改回2019.10.28
%parametros
m  = 2;
r  = 0.2;
...
%        dist = max(dtw(Mi-M),[],2);
   ...
   %Para verificar que se est? realizando el calculo
